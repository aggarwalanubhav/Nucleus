...
#define SV_THREADPOOL_SIZE 5

#define SV_GTPV2C_BUF_LEN	4096

/*GTPv2c IE message types*/
#define SV_IE_CAUSE		2
#define SV_IE_FTEID_C		87
#define SV_IE_PAA		79
#define SV_IE_APN_RESTRICTION	127
#define SV_IE_BEARER_CTX	93
#define SV_IE_EPS_BEARER_ID	73

int
init_sv();

void
handle_sv_message(void *message);
...
int
sv_transation(char * buf, unsigned int len);
