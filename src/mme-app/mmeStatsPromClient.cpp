...
mme_msg_rx_nas_act_ded_br_ctxt_acpt(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","act_ded_br_ctxt_acpt"}})),
mme_msg_rx_nas_act_ded_br_ctxt_rjct(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","act_ded_br_ctxt_rjct"}})),
mme_msg_rx_nas_deact_eps_br_ctxt_acpt(mme_msg_rx_family.Add({{"interface","nas"},{"msg_type","deact_eps_br_ctxt_acpt"}})),
...
mme_msg_rx_s1ap_erab_setup_response(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","erab_setup_response"}})),
mme_msg_rx_s1ap_erab_release_response(mme_msg_rx_family.Add({{"interface","s1ap"},{"msg_type","erab_release_response"}})),
...
mme_msg_rx_s11_create_bearer_request(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","create_bearer_request"}})),
mme_msg_rx_s11_delete_bearer_request(mme_msg_rx_family.Add({{"interface","s11"},{"msg_type","delete_bearer_request"}})),
mme_msg_rx_s3_forward_relocation_response(mme_msg_rx_family.Add({{"interface","s3"},{"msg_type","forward_relocation_response"}})),
mme_msg_rx_s3_forward_relocation_complete(mme_msg_rx_family.Add({{"interface","s3"},{"msg_type","forward_relocation_complete"}})),
mme_msg_rx_sv_ps_to_cs_response(mme_msg_rx_family.Add({{"interface","sv"},{"msg_type","ps_to_cs_response"}})),
mme_msg_rx_sv_ps_to_cs_complete(mme_msg_rx_family.Add({{"interface","sv"},{"msg_type","ps_to_cs_complete"}})),
mme_msg_rx_sv_ps_to_cs_cancel_ack(mme_msg_rx_family.Add({{"interface","sv"},{"msg_type","ps_to_cs_cancel_ack"}}))
{
}
...
mme_msg_tx_nas_act_ded_br_ctxt_request(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","act_ded_br_ctxt_request"}})),
mme_msg_tx_nas_deact_eps_br_ctxt_request(mme_msg_tx_family.Add({{"interface","nas"},{"msg_type","deact_eps_br_ctxt_request"}})),
...
mme_msg_tx_s1ap_erab_setup_request(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","erab_setup_request"}})),
mme_msg_tx_s1ap_erab_release_command(mme_msg_tx_family.Add({{"interface","s1ap"},{"msg_type","erab_release_command"}})),
...
mme_msg_tx_s11_downlink_data_notification_failure_ind(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","downlink_data_notification_failure_ind"}})),
mme_msg_tx_s11_release_bearer_request(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","release_bearer_request"}})),
mme_msg_tx_s11_create_bearer_response(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","create_bearer_response"}})),
mme_msg_tx_s11_delete_bearer_response(mme_msg_tx_family.Add({{"interface","s11"},{"msg_type","delete_bearer_response"}})),
mme_msg_tx_s3_forward_relocation_request(mme_msg_tx_family.Add({{"interface","s3"},{"msg_type","forward_relocation_request"}})),
mme_msg_tx_s3_forward_relocation_complete_ack(mme_msg_tx_family.Add({{"interface","s3"},{"msg_type","forward_relocation_complete_ack"}})),
mme_msg_tx_sv_ps_to_cs_request(mme_msg_tx_family.Add({{"interface","sv"},{"msg_type","ps_to_cs_request"}})),
mme_msg_tx_sv_ps_to_cs_complete_ack(mme_msg_tx_family.Add({{"interface","sv"},{"msg_type","ps_to_cs_complete_ack"}})),
mme_msg_tx_sv_ps_to_cs_cancel(mme_msg_tx_family.Add({{"interface","sv"},{"msg_type","ps_to_cs_cancel"}})),
...
mme_procedures_service_request_proc_pgw_init(mme_procedures_family.Add({{"procedure","SERVICE_REQUEST_PROC"},{"init_by","pgw_init"}})),
...
mme_procedures_srvcc_proc(mme_procedures_family.Add({{"procedure","SRVCC_PROC"}})),
mme_procedures_srvcc_proc_success(mme_procedures_family.Add({{"procedure","SRVCC_PROC"},{"proc_result","success"}})),
mme_procedures_srvcc_proc_failure(mme_procedures_family.Add({{"procedure","SRVCC_PROC"},{"proc_result","failure"}})),
...
mme_procedures_create_bearer_proc(mme_procedures_family.Add({{"procedure","CREATE_BEARER_PROC"}})),
mme_procedures_create_bearer_proc_success(mme_procedures_family.Add({{"procedure","CREATE_BEARER_PROC"},{"proc_result","success"}})),
mme_procedures_create_bearer_proc_failure(mme_procedures_family.Add({{"procedure","CREATE_BEARER_PROC"},{"proc_result","failure"}})),
mme_procedures_delete_bearer_proc(mme_procedures_family.Add({{"procedure","DELETE_BEARER_PROC"}})),
mme_procedures_delete_bearer_proc_success(mme_procedures_family.Add({{"procedure","DELETE_BEARER_PROC"},{"proc_result","success"}})),
mme_procedures_delete_bearer_proc_failure(mme_procedures_family.Add({{"procedure","DELETE_BEARER_PROC"},{"proc_result","failure"}})),
mme_procedures_ded_bearer_activation_proc(mme_procedures_family.Add({{"procedure","DED_BEARER_ACTIVATION_PROC"}})),
mme_procedures_ded_bearer_activation_proc_success(mme_procedures_family.Add({{"procedure","DED_BEARER_ACTIVATION_PROC"},{"proc_result","success"}})),
mme_procedures_ded_bearer_activation_proc_failure(mme_procedures_family.Add({{"procedure","DED_BEARER_ACTIVATION_PROC"},{"proc_result","failure"}})),
mme_procedures_ded_bearer_deactivation_proc(mme_procedures_family.Add({{"procedure","DED_BEARER_DEACTIVATION_PROC"}})),
mme_procedures_ded_bearer_deactivation_proc_success(mme_procedures_family.Add({{"procedure","DED_BEARER_DEACTIVATION_PROC"},{"proc_result","success"}})),
mme_procedures_ded_bearer_deactivation_proc_failure(mme_procedures_family.Add({{"procedure","DED_BEARER_DEACTIVATION_PROC"},{"proc_result","failure"}}))
{
}
...
void mmeStats::increment(mmeStatsCounter name,std::map<std::string,std::string> labels)
{
	...
	case mmeStatsCounter::MME_MSG_RX_NAS_ACT_DED_BR_CTXT_ACPT:
	{
		mme_msg_rx_m->mme_msg_rx_nas_act_ded_br_ctxt_acpt.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","nas","msg_type","act_ded_br_ctxt_acpt",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","nas","msg_type","act_ded_br_ctxt_acpt",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","nas","msg_type","act_ded_br_ctxt_acpt",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_NAS_ACT_DED_BR_CTXT_RJCT:
	{
		mme_msg_rx_m->mme_msg_rx_nas_act_ded_br_ctxt_rjct.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","nas","msg_type","act_ded_br_ctxt_rjct",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","nas","msg_type","act_ded_br_ctxt_rjct",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","nas","msg_type","act_ded_br_ctxt_rjct",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_NAS_DEACT_EPS_BR_CTXT_ACPT:
	{
		mme_msg_rx_m->mme_msg_rx_nas_deact_eps_br_ctxt_acpt.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","nas","msg_type","deact_eps_br_ctxt_acpt",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","nas","msg_type","deact_eps_br_ctxt_acpt",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","nas","msg_type","deact_eps_br_ctxt_acpt",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_S1AP_ERAB_SETUP_RESPONSE:
	{
		mme_msg_rx_m->mme_msg_rx_s1ap_erab_setup_response.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s1ap","msg_type","erab_setup_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s1ap","msg_type","erab_setup_response",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s1ap","msg_type","erab_setup_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_S1AP_ERAB_RELEASE_RESPONSE:
	{
		mme_msg_rx_m->mme_msg_rx_s1ap_erab_release_response.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s1ap","msg_type","erab_release_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s1ap","msg_type","erab_release_response",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s1ap","msg_type","erab_release_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_S11_CREATE_BEARER_REQUEST:
	{
		mme_msg_rx_m->mme_msg_rx_s11_create_bearer_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s11","msg_type","create_bearer_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s11","msg_type","create_bearer_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s11","msg_type","create_bearer_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_S11_DELETE_BEARER_REQUEST:
	{
		mme_msg_rx_m->mme_msg_rx_s11_delete_bearer_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s11","msg_type","delete_bearer_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s11","msg_type","delete_bearer_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s11","msg_type","delete_bearer_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_S3_FORWARD_RELOCATION_RESPONSE:
	{
		mme_msg_rx_m->mme_msg_rx_s3_forward_relocation_response.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s3","msg_type","forward_relocation_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s3","msg_type","forward_relocation_response",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s3","msg_type","forward_relocation_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_S3_FORWARD_RELOCATION_COMPLETE:
	{
		mme_msg_rx_m->mme_msg_rx_s3_forward_relocation_complete.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","s3","msg_type","forward_relocation_complete",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","s3","msg_type","forward_relocation_complete",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","s3","msg_type","forward_relocation_complete",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_SV_PS_TO_CS_RESPONSE:
	{
		mme_msg_rx_m->mme_msg_rx_sv_ps_to_cs_response.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","sv","msg_type","ps_to_cs_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","sv","msg_type","ps_to_cs_response",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","sv","msg_type","ps_to_cs_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_SV_PS_TO_CS_COMPLETE:
	{
		mme_msg_rx_m->mme_msg_rx_sv_ps_to_cs_complete.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","sv","msg_type","ps_to_cs_complete",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","sv","msg_type","ps_to_cs_complete",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","sv","msg_type","ps_to_cs_complete",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_RX_SV_PS_TO_CS_CANCEL_ACK:
	{
		mme_msg_rx_m->mme_msg_rx_sv_ps_to_cs_cancel_ack.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject1 *obj = mme_msg_rx_m->add_dynamic1("interface","sv","msg_type","ps_to_cs_cancel_ack",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject2 *obj = mme_msg_rx_m->add_dynamic2("interface","sv","msg_type","ps_to_cs_cancel_ack",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_rx_DynamicMetricObject3 *obj = mme_msg_rx_m->add_dynamic3("interface","sv","msg_type","ps_to_cs_cancel_ack",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_NAS_ACT_DED_BR_CTXT_REQUEST:
	{
		mme_msg_tx_m->mme_msg_tx_nas_act_ded_br_ctxt_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","nas","msg_type","act_ded_br_ctxt_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","nas","msg_type","act_ded_br_ctxt_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","nas","msg_type","act_ded_br_ctxt_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_NAS_DEACT_EPS_BR_CTXT_REQUEST:
	{
		mme_msg_tx_m->mme_msg_tx_nas_deact_eps_br_ctxt_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","nas","msg_type","deact_eps_br_ctxt_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","nas","msg_type","deact_eps_br_ctxt_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","nas","msg_type","deact_eps_br_ctxt_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S1AP_ERAB_SETUP_REQUEST:
	{
		mme_msg_tx_m->mme_msg_tx_s1ap_erab_setup_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s1ap","msg_type","erab_setup_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s1ap","msg_type","erab_setup_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s1ap","msg_type","erab_setup_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S1AP_ERAB_RELEASE_COMMAND:
	{
		mme_msg_tx_m->mme_msg_tx_s1ap_erab_release_command.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s1ap","msg_type","erab_release_command",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s1ap","msg_type","erab_release_command",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s1ap","msg_type","erab_release_command",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S11_DOWNLINK_DATA_NOTIFICATION_FAILURE_IND:
	{
		mme_msg_tx_m->mme_msg_tx_s11_downlink_data_notification_failure_ind.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s11","msg_type","downlink_data_notification_failure_ind",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s11","msg_type","downlink_data_notification_failure_ind",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s11","msg_type","downlink_data_notification_failure_ind",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S11_CREATE_BEARER_RESPONSE:
	{
		mme_msg_tx_m->mme_msg_tx_s11_create_bearer_response.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s11","msg_type","create_bearer_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s11","msg_type","create_bearer_response",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s11","msg_type","create_bearer_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S11_DELETE_BEARER_RESPONSE:
	{
		mme_msg_tx_m->mme_msg_tx_s11_delete_bearer_response.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s11","msg_type","delete_bearer_response",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s11","msg_type","delete_bearer_response",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s11","msg_type","delete_bearer_response",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S3_FORWARD_RELOCATION_REQUEST:
	{
		mme_msg_tx_m->mme_msg_tx_s3_forward_relocation_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s3","msg_type","forward_relocation_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s3","msg_type","forward_relocation_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s3","msg_type","forward_relocation_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_S3_FORWARD_RELOCATION_COMPLETE_ACK:
	{
		mme_msg_tx_m->mme_msg_tx_s3_forward_relocation_complete_ack.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","s3","msg_type","forward_relocation_complete_ack",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","s3","msg_type","forward_relocation_complete_ack",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","s3","msg_type","forward_relocation_complete_ack",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_SV_PS_TO_CS_REQUEST:
	{
		mme_msg_tx_m->mme_msg_tx_sv_ps_to_cs_request.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","sv","msg_type","ps_to_cs_request",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","sv","msg_type","ps_to_cs_request",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","sv","msg_type","ps_to_cs_request",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_SV_PS_TO_CS_COMPLETE_ACK:
	{
		mme_msg_tx_m->mme_msg_tx_sv_ps_to_cs_complete_ack.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","sv","msg_type","ps_to_cs_complete_ack",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","sv","msg_type","ps_to_cs_complete_ack",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","sv","msg_type","ps_to_cs_complete_ack",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_MSG_TX_SV_PS_TO_CS_CANCEL:
	{
		mme_msg_tx_m->mme_msg_tx_sv_ps_to_cs_cancel.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject1 *obj = mme_msg_tx_m->add_dynamic1("interface","sv","msg_type","ps_to_cs_cancel",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject2 *obj = mme_msg_tx_m->add_dynamic2("interface","sv","msg_type","ps_to_cs_cancel",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_msg_tx_DynamicMetricObject3 *obj = mme_msg_tx_m->add_dynamic3("interface","sv","msg_type","ps_to_cs_cancel",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_SERVICE_REQUEST_PROC_PGW_INIT:
	{
		mme_procedures_m->mme_procedures_service_request_proc_pgw_init.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
	...
	case mmeStatsCounter::MME_PROCEDURES_SRVCC_PROC:
	{
		mme_procedures_m->mme_procedures_srvcc_proc.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","SRVCC_PROC",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","SRVCC_PROC",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","SRVCC_PROC",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_SRVCC_PROC_SUCCESS:
	{
		mme_procedures_m->mme_procedures_srvcc_proc_success.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","SRVCC_PROC","proc_result","success",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","SRVCC_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","SRVCC_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_SRVCC_PROC_FAILURE:
	{
		mme_procedures_m->mme_procedures_srvcc_proc_failure.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","SRVCC_PROC","proc_result","failure",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","SRVCC_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","SRVCC_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_CREATE_BEARER_PROC:
	{
	...
	case mmeStatsCounter::MME_PROCEDURES_CREATE_BEARER_PROC_SUCCESS:
	{
	...
	case mmeStatsCounter::MME_PROCEDURES_CREATE_BEARER_PROC_FAILURE:
	{
	...
	case mmeStatsCounter::MME_PROCEDURES_DELETE_BEARER_PROC:
	{
		mme_procedures_m->mme_procedures_delete_bearer_proc.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","DELETE_BEARER_PROC",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","DELETE_BEARER_PROC",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","DELETE_BEARER_PROC",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_DELETE_BEARER_PROC_SUCCESS:
	{
		mme_procedures_m->mme_procedures_delete_bearer_proc_success.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","DELETE_BEARER_PROC","proc_result","success",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","DELETE_BEARER_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","DELETE_BEARER_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_DELETE_BEARER_PROC_FAILURE:
	{
		mme_procedures_m->mme_procedures_delete_bearer_proc_failure.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","DELETE_BEARER_PROC","proc_result","failure",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","DELETE_BEARER_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","DELETE_BEARER_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_DED_BEARER_DEACTIVATION_PROC:
	{
		mme_procedures_m->mme_procedures_ded_bearer_deactivation_proc.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","DED_BEARER_DEACTIVATION_PROC",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","DED_BEARER_DEACTIVATION_PROC",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","DED_BEARER_DEACTIVATION_PROC",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_DED_BEARER_DEACTIVATION_PROC_SUCCESS:
	{
		mme_procedures_m->mme_procedures_ded_bearer_deactivation_proc_success.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","DED_BEARER_DEACTIVATION_PROC","proc_result","success",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","DED_BEARER_DEACTIVATION_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","DED_BEARER_DEACTIVATION_PROC","proc_result","success",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
	...
	case mmeStatsCounter::MME_PROCEDURES_DED_BEARER_DEACTIVATION_PROC_FAILURE:
	{
		mme_procedures_m->mme_procedures_ded_bearer_deactivation_proc_failure.Increment();
		if(labels.size() == 0) {
		break;
		}
		if(labels.size() == 1) {
		...
		if(it1 != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject1 *obj = mme_procedures_m->add_dynamic1("procedure","DED_BEARER_DEACTIVATION_PROC","proc_result","failure",it->first, it->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject2 *obj = mme_procedures_m->add_dynamic2("procedure","DED_BEARER_DEACTIVATION_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		} 
		...
		if(itf != metrics_map.end()) {
		    ...
		    mme_procedures_DynamicMetricObject3 *obj = mme_procedures_m->add_dynamic3("procedure","DED_BEARER_DEACTIVATION_PROC","proc_result","failure",it1->first, it1->second, it2->first, it2->second, it3->first, it3->second);
		    auto p1 = std::make_pair(s1, obj);
		    metrics_map.insert(p1);
		    obj->counter.Increment();
		}
