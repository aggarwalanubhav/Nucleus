...
SgwsOverloadControlInformationInDeleteBearerCommand::
SgwsOverloadControlInformationInDeleteBearerCommand()
{
    Uint16 mandIe;
...
bool SgwsOverloadControlInformationInDeleteBearerCommand::
encodeSgwsOverloadControlInformationInDeleteBearerCommand(MsgBuffer &buffer,
...
bool SgwsOverloadControlInformationInDeleteBearerCommand::
decodeSgwsOverloadControlInformationInDeleteBearerCommand(MsgBuffer &buffer,
                         SgwsOverloadControlInformationInDeleteBearerCommandData 
                         &data, Uint16 length)
{
...
void SgwsOverloadControlInformationInDeleteBearerCommand::
displaySgwsOverloadControlInformationInDeleteBearerCommandData_v
(SgwsOverloadControlInformationInDeleteBearerCommandData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"SgwsOverloadControlInformationInDeleteBearerCommand:");
    stream.endOfLine();
    stream.incrIndent();
