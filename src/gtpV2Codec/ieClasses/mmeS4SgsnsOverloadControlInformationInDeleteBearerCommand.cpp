...
MmeS4SgsnsOverloadControlInformationInDeleteBearerCommand::
MmeS4SgsnsOverloadControlInformationInDeleteBearerCommand()
{
    Uint16 mandIe;
...
bool MmeS4SgsnsOverloadControlInformationInDeleteBearerCommand::
encodeMmeS4SgsnsOverloadControlInformationInDeleteBearerCommand(MsgBuffer &buffer,
                          ...
                          const &data)
{
    ...
    SequenceNumberIe overloadControlSequenceNumber=
    dynamic_cast<
    SequenceNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(SequenceNumberIeType));
    rc = overloadControlSequenceNumber.encodeSequenceNumberIe(buffer, data.overloadControlSequenceNumber);
    ...
    GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
    startIndex = buffer.getCurrentIndex(); 
    MetricIe overloadReductionMetric=
    dynamic_cast<
    MetricIe&>(GtpV2IeFactory::getInstance().getIeObject(MetricIeType));
    rc = overloadReductionMetric.encodeMetricIe(buffer, data.overloadReductionMetric);
    endIndex = buffer.getCurrentIndex();
    length = endIndex - startIndex;
    ...
    GtpV2Ie::encodeGtpV2IeHeader(buffer, header);
    startIndex = buffer.getCurrentIndex(); 
    EpcTimerIe periodOfValidity=
    dynamic_cast<
    EpcTimerIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcTimerIeType));
    rc = periodOfValidity.encodeEpcTimerIe(buffer, data.periodOfValidity);
    endIndex = buffer.getCurrentIndex();
    length = endIndex - startIndex;
...
bool MmeS4SgsnsOverloadControlInformationInDeleteBearerCommand::
decodeMmeS4SgsnsOverloadControlInformationInDeleteBearerCommand(MsgBuffer &buffer,
                         MmeS4SgsnsOverloadControlInformationInDeleteBearerCommandData 
                         &data, Uint16 length)
{
...
void MmeS4SgsnsOverloadControlInformationInDeleteBearerCommand::
displayMmeS4SgsnsOverloadControlInformationInDeleteBearerCommandData_v
(MmeS4SgsnsOverloadControlInformationInDeleteBearerCommandData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"MmeS4SgsnsOverloadControlInformationInDeleteBearerCommand:");
    stream.endOfLine();
    stream.incrIndent();

    stream.add((char *)"overloadControlSequenceNumber:");
    stream.endOfLine();
    SequenceNumberIe overloadControlSequenceNumber=
    dynamic_cast<
    SequenceNumberIe&>(GtpV2IeFactory::getInstance().getIeObject(SequenceNumberIeType));
    overloadControlSequenceNumber.displaySequenceNumberIe_v(data.overloadControlSequenceNumber, stream);

    stream.add((char *)"overloadReductionMetric:");
    stream.endOfLine();
    MetricIe overloadReductionMetric=
    dynamic_cast<
    MetricIe&>(GtpV2IeFactory::getInstance().getIeObject(MetricIeType));
    overloadReductionMetric.displayMetricIe_v(data.overloadReductionMetric, stream);

    stream.add((char *)"periodOfValidity:");
    stream.endOfLine();
    EpcTimerIe periodOfValidity=
    dynamic_cast<
    EpcTimerIe&>(GtpV2IeFactory::getInstance().getIeObject(EpcTimerIeType));
    periodOfValidity.displayEpcTimerIe_v(data.periodOfValidity, stream);
