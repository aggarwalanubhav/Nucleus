...
#include "listOfSetUpBearersInForwardRelocationResponse.h"
...
ListOfSetUpBearersInForwardRelocationResponse::
ListOfSetUpBearersInForwardRelocationResponse()
{
...
bool ListOfSetUpBearersInForwardRelocationResponse::
encodeListOfSetUpBearersInForwardRelocationResponse(MsgBuffer &buffer,
...
bool ListOfSetUpBearersInForwardRelocationResponse::
decodeListOfSetUpBearersInForwardRelocationResponse(MsgBuffer &buffer,
                         ListOfSetUpBearersInForwardRelocationResponseData 
                         &data, Uint16 length)
{
...
void ListOfSetUpBearersInForwardRelocationResponse::
displayListOfSetUpBearersInForwardRelocationResponseData_v
(ListOfSetUpBearersInForwardRelocationResponseData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"ListOfSetUpBearersInForwardRelocationResponse:");
    stream.endOfLine();
    stream.incrIndent();
