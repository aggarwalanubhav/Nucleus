...
RemoteUeContextConnectedInForwardRelocationRequest::
RemoteUeContextConnectedInForwardRelocationRequest()
{
    Uint16 mandIe;
...
bool RemoteUeContextConnectedInForwardRelocationRequest::
encodeRemoteUeContextConnectedInForwardRelocationRequest(MsgBuffer &buffer,
...
bool RemoteUeContextConnectedInForwardRelocationRequest::
decodeRemoteUeContextConnectedInForwardRelocationRequest(MsgBuffer &buffer,
                         RemoteUeContextConnectedInForwardRelocationRequestData 
                         &data, Uint16 length)
{
...
void RemoteUeContextConnectedInForwardRelocationRequest::
displayRemoteUeContextConnectedInForwardRelocationRequestData_v
(RemoteUeContextConnectedInForwardRelocationRequestData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"RemoteUeContextConnectedInForwardRelocationRequest:");
    stream.endOfLine();
    stream.incrIndent();

    stream.add((char *)"remoteUserId:");
    stream.endOfLine();
    RemoteUserIdIe remoteUserId=
    dynamic_cast<
    RemoteUserIdIe&>(GtpV2IeFactory::getInstance().getIeObject(RemoteUserIdIeType));
    remoteUserId.displayRemoteUserIdIe_v(data.remoteUserId, stream);
    ...
    dynamic_cast<
    RemoteUeIpInformationIe&>(GtpV2IeFactory::getInstance().getIeObject(RemoteUeIpInformationIeType));
    remoteUeIpInformation.displayRemoteUeIpInformationIe_v(data.remoteUeIpInformation, stream);
