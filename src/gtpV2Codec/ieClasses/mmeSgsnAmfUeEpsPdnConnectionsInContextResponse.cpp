...
MmeSgsnAmfUeEpsPdnConnectionsInContextResponse::
MmeSgsnAmfUeEpsPdnConnectionsInContextResponse()
{
    Uint16 mandIe;
    mandIe = ApnIeType;
...
bool MmeSgsnAmfUeEpsPdnConnectionsInContextResponse::
encodeMmeSgsnAmfUeEpsPdnConnectionsInContextResponse(MsgBuffer &buffer,
                          ...
                          const &data)
{
	...
	Uint8 msgType = ContextResponseMsgType;
    ...
    if (data.bearerContextsIePresent)
    {
        ...
        BearerContextsInContextResponse groupedIeInstance =
        dynamic_cast<
        BearerContextsInContextResponse&>(bearerContexts.getGroupedIe(msgType, 0));
        rc = groupedIeInstance.encodeBearerContextsInContextResponse(buffer, data.bearerContexts);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
    ...
    if (data.remoteUeContextConnectedIePresent)
    {
        ...
        RemoteUeContextConnectedInContextResponse groupedIeInstance =
        dynamic_cast<
        RemoteUeContextConnectedInContextResponse&>(remoteUeContextConnected.getGroupedIe(msgType, 0));
        rc = groupedIeInstance.encodeRemoteUeContextConnectedInContextResponse(buffer, data.remoteUeContextConnected);
        endIndex = buffer.getCurrentIndex();
        length = endIndex - startIndex;
...
bool MmeSgsnAmfUeEpsPdnConnectionsInContextResponse::
decodeMmeSgsnAmfUeEpsPdnConnectionsInContextResponse(MsgBuffer &buffer,
                         MmeSgsnAmfUeEpsPdnConnectionsInContextResponseData 
                         &data, Uint16 length)
{
        ...
        switch (ieHeader.ieType){
            ...
            case BearerContextIeType:
            {
                ...
                if(ieHeader.instance == 0)
                {
                    ...
                    BearerContextsInContextResponse groupedIeInstance =
                    dynamic_cast<
                    BearerContextsInContextResponse&>(ieObject.getGroupedIe(msgType, 0));
                    rc = groupedIeInstance.decodeBearerContextsInContextResponse(buffer, data.bearerContexts, ieHeader.length);
            ...
            case RemoteUeContextIeType:
            {
                ...
                if(ieHeader.instance == 0)
                {
                    ...
                    RemoteUeContextConnectedInContextResponse groupedIeInstance =
                    dynamic_cast<
                    RemoteUeContextConnectedInContextResponse&>(ieObject.getGroupedIe(msgType, 0));
                    rc = groupedIeInstance.decodeRemoteUeContextConnectedInContextResponse(buffer, data.remoteUeContextConnected, ieHeader.length);
...
void MmeSgsnAmfUeEpsPdnConnectionsInContextResponse::
displayMmeSgsnAmfUeEpsPdnConnectionsInContextResponseData_v
(MmeSgsnAmfUeEpsPdnConnectionsInContextResponseData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"MmeSgsnAmfUeEpsPdnConnectionsInContextResponse:");
    stream.endOfLine();
    stream.incrIndent();
    ...
    if (data.bearerContextsIePresent)
    {
        ...
        dynamic_cast<
        BearerContextsInContextResponse&>(bearerContexts.getGroupedIe(msgType, 0));
        groupedIeInstance.displayBearerContextsInContextResponseData_v(data.bearerContexts, stream);
	}
     ...
     if (data.remoteUeContextConnectedIePresent)
    {
        ...
        dynamic_cast<
        RemoteUeContextConnectedInContextResponse&>(remoteUeContextConnected.getGroupedIe(msgType, 0));
        groupedIeInstance.displayRemoteUeContextConnectedInContextResponseData_v(data.remoteUeContextConnected, stream);
	}
     if (data.pdnTypeIePresent)
    {
