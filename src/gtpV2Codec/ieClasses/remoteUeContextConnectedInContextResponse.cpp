...
RemoteUeContextConnectedInContextResponse::
RemoteUeContextConnectedInContextResponse()
{
    Uint16 mandIe;
...
bool RemoteUeContextConnectedInContextResponse::
encodeRemoteUeContextConnectedInContextResponse(MsgBuffer &buffer,
...
bool RemoteUeContextConnectedInContextResponse::
decodeRemoteUeContextConnectedInContextResponse(MsgBuffer &buffer,
                         RemoteUeContextConnectedInContextResponseData 
                         &data, Uint16 length)
{
...
void RemoteUeContextConnectedInContextResponse::
displayRemoteUeContextConnectedInContextResponseData_v
(RemoteUeContextConnectedInContextResponseData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"RemoteUeContextConnectedInContextResponse:");
    stream.endOfLine();
    stream.incrIndent();
