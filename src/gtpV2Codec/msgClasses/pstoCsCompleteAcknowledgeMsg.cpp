...
PstoCsCompleteAcknowledgeMsg::PstoCsCompleteAcknowledgeMsg()
{
    msgType = PstoCsCompleteAcknowledgeMsgType;
    Uint16 mandIe;
    mandIe = CauseIeType;
...
bool PstoCsCompleteAcknowledgeMsg::encodePstoCsCompleteAcknowledgeMsg(MsgBuffer &buffer,
...
bool PstoCsCompleteAcknowledgeMsg::decodePstoCsCompleteAcknowledgeMsg(MsgBuffer &buffer,
 PstoCsCompleteAcknowledgeMsgData 
 &data, Uint16 length)
{
...
void PstoCsCompleteAcknowledgeMsg::
displayPstoCsCompleteAcknowledgeMsgData_v(PstoCsCompleteAcknowledgeMsgData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"PstoCsCompleteAcknowledgeMsg:");
    stream.endOfLine();
    stream.incrIndent();
