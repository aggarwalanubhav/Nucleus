...
SrvccPsToCsCancelAcknowledgeMsg::SrvccPsToCsCancelAcknowledgeMsg()
{
    msgType = SrvccPsToCsCancelAcknowledgeMsgType;
    Uint16 mandIe;
    mandIe = CauseIeType;
...
bool SrvccPsToCsCancelAcknowledgeMsg::encodeSrvccPsToCsCancelAcknowledgeMsg(MsgBuffer &buffer,
...
bool SrvccPsToCsCancelAcknowledgeMsg::decodeSrvccPsToCsCancelAcknowledgeMsg(MsgBuffer &buffer,
 SrvccPsToCsCancelAcknowledgeMsgData 
 &data, Uint16 length)
{
...
void SrvccPsToCsCancelAcknowledgeMsg::
displaySrvccPsToCsCancelAcknowledgeMsgData_v(SrvccPsToCsCancelAcknowledgeMsgData const &data, Debug &stream)
{
    stream.incrIndent();
    stream.add((char *)"SrvccPsToCsCancelAcknowledgeMsg:");
    stream.endOfLine();
    stream.incrIndent();
